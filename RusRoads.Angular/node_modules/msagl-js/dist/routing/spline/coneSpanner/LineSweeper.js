...
export class LineSweeper extends LineSweeperBase /*implements IConeSweeper*/ {
    ...
    Show(curves, fn) {
        ...
        for (const s of this.rightConeSides) {
            ...
            if (s instanceof BrokenConeSide)
                l.push(DebugCurve.mkDebugCurveCI('brown', LineSweeper.Diamond(s.start)));
            l.push(DebugCurve.mkDebugCurveWCI(0.5, 'green', this.ExtendSegmentToZ(s.Cone.LeftSide)));
            if (s.Cone.LeftSide instanceof BrokenConeSide)
                l.push(DebugCurve.mkDebugCurveCI('green', LineSweeper.Diamond(s.Cone.LeftSide.start)));
        }
        //            l.pushRange(
    ...
    GetRbNodeEmergency(rbNode, leftConeSide) {
