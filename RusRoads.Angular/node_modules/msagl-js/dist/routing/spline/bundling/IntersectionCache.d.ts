...
export declare class IntersectionCache {
    metroGraphData: MetroGraphData;
    bundlingSettings: BundlingSettings;
    costCalculator: CostCalculator;
    cdt: Cdt;
    constructor(metroGraphData: MetroGraphData, bundlingSettings: BundlingSettings, costCalculator: CostCalculator, cdt: Cdt);
    InitializeCostCache(): void;
    UpdateCostCache(node: Station): void;
