...
export class StraightLineEdges extends Algorithm {
    ...
    static CreateSimpleEdgeCurveWithUnderlyingPolyline(geomedge) {
        ...
        Arrowhead.trimSplineAndCalculateArrowheadsII(geomedge, geomedge.source.boundaryCurve, geomedge.target.boundaryCurve, geomedge.curve, false);
    }
