...
export class EdgeTracer {
    constructor(edge, triangles, front, leftPolygon, rightPolygon) {
        this.elementsToBeRemovedFromFront = new Array();
        this.removedTriangles = new Array();
        this.edge = edge;
...
//# sourceMappingURL=EdgeTracer.js.map