...
export class ObstacleTree {
    ...
    CreateConvexHulls() {
        ...
        for (const component of connectedComponents) {
            ...
            const points = flatMap(obstacles, (p) => Array.from(p.VisibilityPolyline));
    ...
    InsideObstacleHitTest(location, obstacle) {
        ...
        if (2 == xxs.length) {
            const firstInt = GeomConstants.RoundPoint(xxs[0].x);
            const secondInt = GeomConstants.RoundPoint(xxs[1].x);
