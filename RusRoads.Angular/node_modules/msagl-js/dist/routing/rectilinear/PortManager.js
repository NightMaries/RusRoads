...
export class PortManager {
    ...
    CreateObstaclePortEntrancesFromPoints(oport) {
        ...
        const curveBox = Rectangle.mkPP(GeomConstants.RoundPoint(oport.PortCurve.boundingBox.leftBottom), GeomConstants.RoundPoint(oport.PortCurve.boundingBox.rightTop));
        ...
        const location = GeomConstants.RoundPoint(oport.PortLocation);
        let found = false;
