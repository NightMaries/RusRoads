...
export class RectilinearEdgeRouter extends Algorithm {
    ...
    constructor(obstacles, padding, cornerFitRadius, useSparseVisibilityGraph, useObstacleRectangles) {
        super(null);
    ...
    //  <param name="useSparseVisibilityGraph">If true, use a sparse visibility graph, which saves memory for large graphs
    //  but may select suboptimal paths</param>
    static constructorINNB(obstacles, padding, cornerFitRadius, useSparseVisibilityGraph) {
    ...
    //  <param name="useSparseVisibilityGraph">If true, use a sparse visibility graph, which saves memory for large graphs
    //  but may select suboptimal paths</param>
    static constructorGNANB(graph, geomEdges, padding, cornerFitRadius, useSparseVisibilityGraph) {
    ...
    static constructorGNANBB(graph, geomEdges, padding, cornerFitRadius, useSparseVisibilityGraph, useObstacleRectangles) {
