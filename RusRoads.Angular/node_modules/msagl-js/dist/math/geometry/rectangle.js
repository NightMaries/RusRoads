...
export class Rectangle {
    ...
    static rectangleFromLeftBottomAndSize(left, bottom, sizeF) {
    ...
    static rectangleOnRectangles(rectangles) {
        const r = Rectangle.mkEmpty();
    ...
    addWithCheck(point) {
        let wider;
        if ((wider = point.x < this.left_))
            this.left_ = point.x;
        else if ((wider = this.right_ < point.x))
            this.right_ = point.x;
        let higher;
        if ((higher = point.y > this.top_))
            this.top_ = point.y;
        else if ((higher = this.bottom_ > point.y))
            this.bottom = point.y;
        return wider || higher;
    }
    // adding rectangle
