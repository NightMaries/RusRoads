    ...
    *Constraints() {
    ...
    SolvePar(solverParameters) {
        ...
        if (this.solverParams.OuterProjectIterationsLimit < 0) {
            ...
            this.solverParams.OuterProjectIterationsLimit = 100 * (Math.log2(this.numberOfVariables) + 1);
        }
        if (this.solverParams.InnerProjectIterationsLimit < 0) {
            ...
            this.solverParams.InnerProjectIterationsLimit = this.numberOfConstraints * 2 + 100 * (Math.log2(this.numberOfConstraints) + 1);
        }
    ...
    RunProject(/* out */ violationsFound) {
